...
// ============================================================================
// Local AI Codex handler — uses @openai/codex-sdk configured to talk to a
// local LLM (e.g. Ollama, node-llama-cpp) instead of the OpenAI API.
// ============================================================================

export const handleLocalAICodex = async ({
    req,
    res,
    message,
    workspacePath = "",
    ...
    // --- Codex SDK configured for local AI ---
    ...
    try {
        ...
        if (err.name === "AbortError") {
            ...
            writeSSEEvent(
                ...
                JSON.stringify({
                    type: "error",
                    message: err.message ?? "Local AI Codex stream failed",
                }),
                "error",
            );
        }
