...
function EmptyChat() {
	return (
		<div className="flex flex-col items-center text-center max-w-[360px] mt-24 gap-3">
			<Icon name="sparkles" size="2.5rem" className="text-[var(--text-dim)]" />
			...
			<p className="text-sm text-[var(--text-secondary)] leading-relaxed m-0">
				...
				directory, and send a message. The agent's response will
				stream in real-time.
			</p>
		</div>
	);
					...
					{selectedAgent && (
						<div className="flex items-center gap-2 mt-1">
							...
							<span className="text-xs text-[var(--text-secondary)]">
								<code>{selectedAgent.binaryPath ?? selectedAgent.agent.commands[0]}</code>
							</span>
						</div>
					)}
				</div>
