...
const ICON_PATHS: Record<string, string> = {
    ...
    plug: ["M9 2v4", "M15 2v4", "M7 6h10l1 5-2 3v6h-8v-6l-2-3 1-5Z"].join(" "),

    search: ["M11 3a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z", "M21 21l-5-5"].join(" "),
...
export function Icon({
    ...
    if (BrandComponent) {
        return <BrandComponent size={size} className={className} {...rest} />;
    }
